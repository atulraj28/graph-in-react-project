import './App.css';
import { XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, BarChart, Bar, ScatterChart, Scatter } from 'recharts';
var array = [
  {
    "Alcohol": 1,
    "Malic Acid": 14.23,
...
function App() {
  ...
  array.sort(GetSortOrder("Color intensity")); //Pass the attribute to be sorted on        
  ...
  return (
    <>
      ...
      <h1 className="chart-heading">Scatter Chart</h1>
      <ResponsiveContainer width="100%" aspect={3}>
        <ScatterChart
          width={500}
          height={300}
        ...
        >
          <CartesianGrid strokeDasharray="3 3" />
          <XAxis dataKey="Color intensity" />
          <YAxis dataKey="Hue" />
          <Tooltip />
          <Legend />
          <Scatter dataKey="Color intensity" stroke="#61161e" fill="#0910d9" />
        </ScatterChart>
      </ResponsiveContainer>
    </>
